...
const userService = __importStar(require("../../api/user/user.service"));
      ...
      (email, password, done) =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          try {
            ...
            const validate = yield isValidPassword(
              password,
              (_a = user.password) !== null && _a !== void 0 ? _a : ""
            );

            if (!validate) {
              done(
                (0, http_errors_1.default)(401, "Invalid email or password"),
                false
              );
              return;
            }
            const { password: _p } = user,
